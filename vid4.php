...
// Randomly pick one video from the array
			...
			<object width="425" height="350"><param name="stuffs" value="stuff" name="autoplay" value="true"></param><param name="wmode" value="transparent"></param><embed src="<?php echo $content_array[3];?>" type="application/x-shockwave-flash" wmode="transparent" name="content" width="425" height="350"></embed></object>
		</div>
