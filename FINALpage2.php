...
<body>
	...
	<header>
		...
		<section>
		<p>Welcome to my site, <b><?php echo $_POST['username'];?></b>! This is just a simple webpage that displays a handful of my favorite images and music videos. Rate and comment below!</p>
...
// Randomly pick one video from the array
				...
				<object width="425" height="350"><param id="stuff" name="stuffs" value="stuff" name="autoplay" value="true"></param><param name="wmode" value="transparent"></param><embed src="<?php echo $content;?>" type="application/x-shockwave-flash" wmode="transparent" name="content" width="425" height="350"></embed></object>
			</div>

			<div id="randomizer"><button type="reload" name="Randomize" class="myButton" value="Randomize"onClick= "window.location='FINALpage2.php'">Randomize!</button>
